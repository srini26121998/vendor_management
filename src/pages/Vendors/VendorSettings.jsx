                                    ...
                                    {field.type === 'toggle' ? (
                                        <div className="flex items-center gap-3">
                                            <button
                                                ...
                                                style={{ background: (toggles[field.label] ?? field.defaultVal) ? '#166534' : '#cbd5e1' }}>
                                        ...
                                        <select defaultValue={field.options?.[0]}
                                            className="w-full text-sm border border-slate-200 rounded-xl px-3 py-2 bg-slate-50 focus:outline-none focus:border-green-800">
                                        ...
                                        <div className="flex items-center gap-1">
                                            ...
                                            <input type={field.type} defaultValue={field.defaultVal}
                                                className="flex-1 text-sm border border-slate-200 rounded-xl px-3 py-2 bg-slate-50 focus:outline-none focus:border-green-800" />
                                        </div>
                                    )}
                                </div>
                            ))}
